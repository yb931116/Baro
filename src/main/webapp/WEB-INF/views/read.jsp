			...
			<table class="table customTable">
				...
				<tbody>
					<tr>
						...
						<td class="colAns layerModal">R&D 기획사업 실적에 대한 DB수록관리로 공유 조회가 해결된다</td>
						<th scope="row" class="colNum"></th>
						<td class="colPro layerModal">R&D기획사업 실적에 대한 요약된 핵심 내용의 부재로 공개비교 및 타분야
					...
					<tr>
						...
						<td class="colAns layerModal">경영/행정기획사업 실적에 대한 DB수록관리로 공유/조회가 해결된다</td>
						<th scope="row" class="colNum">
						</th>
						<td class="colPro layerModal">경영/행정 분야 기획사업실적에 대한 요약된 핵심내용의 부재로 공개비교 및
